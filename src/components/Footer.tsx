...
export default function Footer() {
  return (
    <>
      <footer id='footer' className='bg-black px-6 py-12 text-white md:px-10'>
        <div>
          ...
          <div className='mt-6 flex items-center gap-2 text-base font-medium text-white'>
            <a href='#terms-service' className='transition hover:text-neutral-300'>
              이용약관
            </a>

            <span className='text-neutral-500'>|</span>

            <a href='#terms-privacy' className='transition hover:text-neutral-300'>
              개인정보처리방침
            </a>
          </div>
      ...
      <TermsModal id='terms-service' title={TERMS_DATA.service.title} content={TERMS_DATA.service.content} />

      <TermsModal id='terms-privacy' title={TERMS_DATA.privacy.title} content={TERMS_DATA.privacy.content} />
    </>
  );
}
